    ...
    fetch("https://diplomatic-beauty-production.up.railway.app/api/packing-store/all")
      ...
      .then((data) => {
        const filteredData = data.filter(
          (item) =>
            item.storePackingTypeIn === "Fried Curry Powder" ||
            item.storePackingTypeOut === "Fried Curry Powder"
        );
...
export default PackFriedCurryPowder;
